...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  <div class="modal-bg" id="order-modal">
    <div class="modal order-modal-box">
      ...
      <form id="order-form">
        ...
        <div style="margin-top:14px;"><label>Adresse de livraison</label><input id="o-address" required placeholder="Adresse complète, commune"></div>
  ...
  function refreshTotal(){
    ...
    totalBox.innerHTML = `
      ...
      <div class="order-total-row"><span>Livraison (${modeSelect.options[modeSelect.selectedIndex].text} — ${wilayaSelect.value})</span><b>${shippingFee ? formatDZD(shippingFee) : 'À confirmer'}</b></div>
